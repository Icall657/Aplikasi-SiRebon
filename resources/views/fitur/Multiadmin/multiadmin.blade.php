...
<head>
    ...
    <title>Multiadmin SiRepal</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('multiadmin.index') }}">
                ...
                <div class="container-fluid">
                    ...
                    <div class="table-container">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="{{ route('multiadmin.create') }}" class="btn btn-primary btn-add">Tambah Data</a>
                        </div>
                                ...
                                @if ($users->isEmpty())
                                    <tr>
                                        <td colspan="4" class="text-center">
                                            <div class="alert alert-warning m-0">Tidak ada data pengguna.</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
