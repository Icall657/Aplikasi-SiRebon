            ...
            <div class="card-body">
                <form action="{{ route('kapalku.update', $kapal->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_kapal') is-invalid @enderror" id="nama_kapal" name="nama_kapal" value="{{ old('nama_kapal', $kapal->nama_kapal) }}" autocomplete="off">
                        @error('nama_kapal')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ukuran') is-invalid @enderror" id="ukuran" name="ukuran" value="{{ old('ukuran', $kapal->ukuran) }}" autocomplete="off">
                        @error('ukuran')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
